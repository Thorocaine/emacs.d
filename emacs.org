...
#+begin_src emacs-lisp
  (defun efs/org-font-setup ()
    ...
    (set-face-attribute 'org-date            nil :inherit '(shadow fixed-pitch) :height 100)
    (set-face-attribute 'org-table           nil :inherit '(shadow fixed-pitch) :height 100)
    (set-face-attribute 'org-formula         nil :inherit '(shadow fixed-pitch) :height 100)
